...
public static class ExtensionsTuples {
    ...
    public static void Deconstruct(this Vector3 o,
                    out float x,
                    out float y,
                    out float z) => (x,y,z) = (o.x, o.y, o.z);

    public static void Deconstruct(this (float,float,float) o, out Vector3 v) =>
        v = new Vector3(o.Item1,o.Item2,o.Item3);

    public static void Deconstruct(this (double,double,double) o, out Vector3 v) =>
    ...
    public static void Deconstruct(this Transform o,
                    out Vector3 position,
                    out Quaternion rotation) =>
        (position, rotation) = (o.position, o.rotation);

    public static void AddForce(this Rigidbody o,
                    (float,float,float) force,
                    ForceMode mode=ForceMode.Force) =>
        o.AddForce(force.ToVector(), mode);

    public static void AddTorque(this Rigidbody o,
                    (float,float,float) force,
                    ForceMode mode=ForceMode.Force) =>
        o.AddTorque(force.ToVector(), mode);
