...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplanePropellerAnimator : MonoBehaviour
    {
        ...
        [SerializeField] protected Transform m_PropellorModel;
        // The plane used for the blurred propellor textures.
        [SerializeField] protected Transform m_PropellorBlur;
        // An array of increasingly blurred propellor textures.
        [SerializeField] protected Texture2D[] m_PropellorBlurTextures;
        // The point at which the blurred textures start.
        [SerializeField] [Range(0f,1f)] protected float m_ThrottleBlurStart = 0.25f;
        [SerializeField] [Range(0f, 1f)] protected float m_ThrottleBlurEnd = 0.5f;      // The point at which the blurred textures stop changing.
        [SerializeField] protected float m_MaxRpm = 2000;                               // The maximum speed the propellor can turn at.
