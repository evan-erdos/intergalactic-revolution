...
/// - path : unescaped URL to use
/// - then : invoked after download is done
...
/// - path : unescaped URL to download from
/// - then : invoked if download completes and returns typed object
